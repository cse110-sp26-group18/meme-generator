...
MemeGen.MemeSearch = (function () {
  ...
  var EMOTION_QUERY_EXPANSIONS = {
    ...
    surprised: ['surprised', 'surprise', 'shocked', 'stunned', 'astonished', 'speechless', 'unexpected', 'wow', 'amazed'],
    surprise: ['surprise', 'surprised', 'shocked', 'stunned', 'astonished', 'unexpected', 'wow', 'amazed'],
    ...
    happy: ['happy', 'happiness', 'joy', 'joyful', 'excited', 'excitement', 'pleased', 'proud', 'relieved', 'celebration', 'success'],
    excited: ['excited', 'excitement', 'happy', 'happiness', 'joy', 'joyful', 'eager', 'hyped', 'thrilled'],
    excitement: ['excitement', 'excited', 'happy', 'happiness', 'joy', 'joyful', 'eager', 'hyped', 'thrilled'],
    ...
    wow: ['wow', 'surprised', 'surprise', 'shocked', 'amazed', 'happy', 'excited'],
  ...
  var EMOTION_INFLECTIONS = {
    ...
    joy: ['joy', 'joyful'],
    joyful: ['joy', 'joyful'],
    amaze: ['amaze', 'amazed', 'amazing'],
    amazed: ['amaze', 'amazed', 'amazing'],
    amazing: ['amaze', 'amazed', 'amazing'],
  ...
  var PHRASE_QUERY_EXPANSIONS = {
    ...
    wow: ['wow', 'surprised', 'surprise', 'shocked', 'amazed', 'happy', 'excited'],
    'oh wow': ['wow', 'surprised', 'surprise', 'shocked', 'amazed', 'happy', 'excited'],
