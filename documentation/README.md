...
This file tracks what happens during each iteration of the project. It includes the AI use, what worked, what did not work, and what should be fixed or improved in the next version.
